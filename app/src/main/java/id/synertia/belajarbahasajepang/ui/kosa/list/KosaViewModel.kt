...
@HiltViewModel
class KosaViewModel @Inject constructor(
    private val repository: APIRepository,
    private val networkHelper: NetworkHelper
) : ViewModel() {

    private val _response = MutableLiveData<Resource<List<Kosa>>>()
    val response: LiveData<Resource<List<Kosa>>>
        get() = _response
    ...
    fun get(id:String) {
        viewModelScope.launch {
            ...
            if (networkHelper.isNetworkConnected()) {
                repository.getKosa(id).let { response ->
